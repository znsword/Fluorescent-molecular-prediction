...
model_mlp = GradientBoostingRegressor(learning_rate=0.01,
                                      max_depth=31,# 最大深度,吸收用
                                      # max_depth=10,  # 最大深度,发射用
                                      max_features=2,  # 最大特征数,吸收用
                                      # max_features=1,  # 最大特征数,发射用
                                      min_samples_leaf=5,  # 叶子结点的最小样本数
                                      n_estimators=300,  # 决策树的数量
                                      verbose=True)
